...
parser.add_argument("--question_dir", default="/path/to/CAG/datasets/POPE/coco", help="Directory containing POPE question JSON files")
parser.add_argument("--image_folder", default="/path/to/CAG/datasets/POPE/coco/val2014", help="Path to image folder")
