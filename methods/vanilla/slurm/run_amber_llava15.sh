...
#SBATCH --time=6:00:00
#SBATCH --output=/scratch/mmarvani/LVLM/lvlm-logs/amber_llava15_%j.out
#SBATCH --error=/scratch/mmarvani/LVLM/lvlm-logs/amber_llava15_%j.err
...
python experiments/run_amber_baselines.py \
    ...
    --log_dir /scratch/mmarvani/LVLM/lvlm-logs/AMBER/baselines_llava \
    --max_new_tokens 512 \
    --num_beams 1 \
    --load_in_8bit
