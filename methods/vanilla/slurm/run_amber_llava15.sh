...
#SBATCH --time=6:00:00
#SBATCH --output=/path/to/LVLM/lvlm-logs/amber_llava15_%j.out
#SBATCH --error=/path/to/LVLM/lvlm-logs/amber_llava15_%j.err
...
python experiments/run_amber_baselines.py \
    ...
    --log_dir /path/to/LVLM/lvlm-logs/AMBER/baselines_llava \
    --max_new_tokens 512 \
    --num_beams 1 \
    --load_in_8bit
