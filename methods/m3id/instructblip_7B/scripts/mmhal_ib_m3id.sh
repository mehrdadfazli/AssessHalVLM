...
#SBATCH --job-name=mmhal-ib-m3id
#SBATCH --output=/scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_M3ID/slurm-%j.log

set -euo pipefail

mkdir -p /scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_M3ID

source /scratch/smansou3/avisc_env.sh
source /scratch/smansou3/avisc-env/bin/activate
cd /scratch/smansou3/LVLM/AvisC

LOG_PATH=/scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_M3ID
...
echo "python experiments/cd_scripts/mmhal_eval_instructblip.py \\
    --model-path instructblip-vicuna7b \\
    --data_path /scratch/smansou3/LVLM/datasets/MMHal-Bench/images \\
...
EXIT_CODE=0
python experiments/cd_scripts/mmhal_eval_instructblip.py \
    --model-path instructblip-vicuna7b \
    --data_path /scratch/smansou3/LVLM/datasets/MMHal-Bench/images \
    --jsonl_path /scratch/smansou3/LVLM/datasets/MMHal-Bench/mmhal_inputs.jsonl \
    --log_path "$LOG_PATH" \
