...
#SBATCH --output=/scratch/smansou3/LVLM/lvlm-logs/AMBER/instructblip_M3ID/slurm-%j.log

set -euo pipefail

mkdir -p /scratch/smansou3/LVLM/lvlm-logs/AMBER/instructblip_M3ID

source /scratch/smansou3/avisc_env.sh
source /scratch/smansou3/avisc-env/bin/activate
cd /scratch/smansou3/LVLM/AvisC

LOG_PATH=/scratch/smansou3/LVLM/lvlm-logs/AMBER/instructblip_M3ID
