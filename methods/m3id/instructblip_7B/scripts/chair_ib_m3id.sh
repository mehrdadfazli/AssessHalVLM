...
#SBATCH --output=/path/to/LVLM/lvlm-logs/CHAIR/instructblip_M3ID/slurm-%j.log

set -euo pipefail

mkdir -p /path/to/LVLM/lvlm-logs/CHAIR/instructblip_M3ID

source /path/to/avisc_env.sh
source /path/to/avisc-env/bin/activate
cd /path/to/LVLM/AvisC

LOGDIR=/path/to/LVLM/lvlm-logs/CHAIR/instructblip_M3ID
