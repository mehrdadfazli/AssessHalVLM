...
#SBATCH --job-name=chair-ib-m3id
#SBATCH --output=/scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_M3ID/slurm-%j.log

set -euo pipefail

mkdir -p /scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_M3ID

source /scratch/smansou3/avisc_env.sh
source /scratch/smansou3/avisc-env/bin/activate
cd /scratch/smansou3/LVLM/AvisC

LOGDIR=/scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_M3ID
...
EXIT_CODE=0
python experiments/cd_scripts/chair_eval_instructblip.py \
