...
def parse_args():
    ...
    parser.add_argument("--jsonl_path", type=str, default="/path/to/LVLM/datasets/MMStar/mmstar_inputs.jsonl")
    parser.add_argument("--data_path", type=str, default="/path/to/LVLM/datasets/MMStar/images")
    parser.add_argument("--log_path", type=str, default="/path/to/LVLM/lvlm-logs/MMStar/llava_next")
