...
#SBATCH --output=/path/to/LVLM/lvlm-logs/MMStar/llava_M3ID/slurm-%j.log

set -euo pipefail

mkdir -p /path/to/LVLM/lvlm-logs/MMStar/llava_M3ID

source /path/to/avisc_env.sh
source /path/to/avisc-env/bin/activate
cd /path/to/LVLM/AvisC

LOG_PATH=/path/to/LVLM/lvlm-logs/MMStar/llava_M3ID
