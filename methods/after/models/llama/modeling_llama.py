...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        # idx = torch.where(hidden_states == 0)
...
class LlamaForCausalLM(LlamaPreTrainedModel):
    ...
    def prepare_inputs_for_generation(
        ...
        if inputs_embeds is not None and (past_key_values is None or len(past_key_values.key_cache) == 0):
