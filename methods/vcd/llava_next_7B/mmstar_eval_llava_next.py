"""
MMStar evaluation for LLaVA-NeXT (LlavaNextForConditionalGeneration).
...
- Output schema {**item, "response": text} matches our existing mmstar_eval_llava.py
- No manual processor.patch_size / vision_feature_select_strategy (LlavaNextProcessor has them)
...
def parse_args():
    ...
    # Standard (mirror mmstar_eval_llava.py)
    parser.add_argument("--model-path", type=str, default="llava-hf/llava-v1.6-vicuna-7b-hf")
    parser.add_argument("--jsonl_path", type=str, default="/scratch/smansou3/LVLM/datasets/MMStar/mmstar_inputs.jsonl")
    parser.add_argument("--data_path", type=str, default="/scratch/smansou3/LVLM/datasets/MMStar/images")
    parser.add_argument("--log_path", type=str, default="/scratch/smansou3/LVLM/lvlm-logs/MMStar/llava_next")
...
def main():
    ...
    for item in tqdm(pending, desc="MMStar LLaVA-NeXT"):
        ...
        out_record = {**item, "response": response}
