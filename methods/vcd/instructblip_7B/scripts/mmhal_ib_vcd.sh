...
#SBATCH --output=/path/to/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD/slurm-%j.log

set -euo pipefail

mkdir -p /path/to/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD

source /path/to/avisc_env.sh
source /path/to/avisc-env/bin/activate
cd /path/to/LVLM/AvisC

LOG_PATH=/path/to/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD
