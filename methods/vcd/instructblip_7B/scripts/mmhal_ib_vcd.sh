...
#SBATCH --job-name=mmhal-ib-vcd
#SBATCH --output=/scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD/slurm-%j.log

set -euo pipefail

mkdir -p /scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD

source /scratch/smansou3/avisc_env.sh
source /scratch/smansou3/avisc-env/bin/activate
cd /scratch/smansou3/LVLM/AvisC

LOG_PATH=/scratch/smansou3/LVLM/lvlm-logs/MMHal-Bench/instructblip_VCD
