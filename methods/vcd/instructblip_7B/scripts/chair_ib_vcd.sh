...
#SBATCH --job-name=chair-ib-vcd
#SBATCH --output=/scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_VCD/slurm-%j.log

set -euo pipefail

mkdir -p /scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_VCD

source /scratch/smansou3/avisc_env.sh
source /scratch/smansou3/avisc-env/bin/activate
cd /scratch/smansou3/LVLM/AvisC

LOGDIR=/scratch/smansou3/LVLM/lvlm-logs/CHAIR/instructblip_VCD
