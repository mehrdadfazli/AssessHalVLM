...
if __name__ == "__main__":
    ...
    parser.add_argument("--mmhal_path", type=str, default="/scratch/mmarvani/LVLM/datasets/mmhal-bench")
    parser.add_argument("--image-folder", type=str, default="/scratch/mmarvani/LVLM/datasets/mmhal-bench/images")
