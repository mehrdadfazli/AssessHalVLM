...
configs = [
    ...
    {'name': 'Greedy, alpha=2', 'sample': False, 'alpha': 2.0, 'beta': 0.5, 'temp': 1.0},
    {'name': 'Greedy, alpha=1', 'sample': False, 'alpha': 1.0, 'beta': 0.5, 'temp': 1.0},
]
    ...
    for item in data:
        ...
        with torch.inference_mode():
            outputs = model.generate(
                ...
                use_nucleus_sampling=cfg['sample'],
                num_beams=1,
                top_p=1.0,
