...
#SBATCH --output=/scratch/mmarvani/LVLM/lvlm-logs/agla_chair_%j.out
#SBATCH --error=/scratch/mmarvani/LVLM/lvlm-logs/agla_chair_%j.err
...
python run_llava_chair.py \
    ...
    --answers-file /scratch/mmarvani/LVLM/lvlm-logs/AGLA/llava15_chair_agla_500.jsonl \
    --use_agla \
    --alpha 2 \
    --beta 0.5 \
    --seed 42
